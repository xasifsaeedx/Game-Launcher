...
var tests = new (string Name, Func<Task> Run)[]
{
    ...
    ("Steam history API parses owned games and playtime", SteamHistoryApiParsesOwnedGames),
...
static async Task SteamHistoryApiParsesOwnedGames()
{
    const string json =
        """
        {
...
static async Task SteamHistoryCredentialsAreProtectedAtRest()
{
    using var temp = new TempDirectory();
    var path = Path.Combine(temp.Path, "launcher.db");
...
static async Task GenericCsvHistoryImporterReadsFlexibleColumns()
{
    using var temp = new TempDirectory();
...
static async Task GenericJsonHistoryImporterReadsGamesArray()
{
    using var temp = new TempDirectory();
...
static async Task HistoryRepositoryKeepsLargestSnapshot()
{
    using var temp = new TempDirectory();
